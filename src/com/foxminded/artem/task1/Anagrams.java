...
public class Anagrams {
	...
	public String doLetterReverse(String input) {
		try {
			String reversedInput = reverseLettersOnlyEveryWord(input);
	...
	private String reverseLettersOnlyEveryWord(String Input) {
